 ...
 */
class getCrudRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CrudRepository' shared autowired service.
     *
     * @return \App\Repository\CrudRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CrudRepository.php';

        return $container->privates['App\\Repository\\CrudRepository'] = new \App\Repository\CrudRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
